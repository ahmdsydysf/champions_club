...
class SuggestSportController extends Controller
{
    ...
    public function old_suggest(Request $request)
    {
        /*=========
        height: height,
        gender: gender,
        ...
        foreach ($test as $index => $row) {
            ...
            <div class="row">
                ...
                <div class="card col-sm-12 full_sport_details">
                    ...
                    <div class="card-body">
                    <h5 id="ajName" class="card-title sport_subtitle">' . $row->sport_title_ar . '</h5>
                    <p id="ajDesc" class="card-text sport_overview">' . $row->sport_overview_ar . '</p>
                    </div>
                </div>
    </div>
