            ...
            <div class="container">
                @foreach ($general_service as $row)
                    <div class="content-box wow fadeIn"> <span></span>
                        ...
                        <p>{{ $row->overview_en }}</p>
                        <a href="#"><img src="{{ asset('web_assets/images/icon-right-arrow.svg') }}"
                                alt="Image"></a>
                    </div>
                @endforeach
        ...
        <div class="sides bg-image wow fadeIn" data-background="{{ asset('web_assets/images/side-image01.jpg') }}">
            ...
            <a href="{{ $aboutUs->about_video ?? '' }}" class="play-btn" data-fancybox>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    x="0px" y="0px" viewBox="0 0 104 104" enable-background="new 0 0 104 104"
                    xml:space="preserve">
                    <path fill="none" stroke="#FFFFFF" stroke-width="5" stroke-miterlimit="10"
                    ...
                    <div class="col-lg-12">
                        <div class="swiper-carousel2 wow fadeIn">
                            <div class="swiper-wrapper ">
                                @foreach ($cups as $row)
                                    <div class="swiper-slide">
                                        <div class="flip-box" data-flip-direction="horizontal-to-left"
                                            data-h_text_align="left" data-v_text_align="center">
                                            <div class="flip-box-front" data-bg-overlay="true" data-text-color="light">
                                                <div class="inner">
                                                    <figure> <img src="{{ asset('uploads/cups/' . $row->image) }}"
                                                            alt="Image">
                                                    </figure>
                                                </div>
                                                <!-- end inner -->
                ...
                <div class="col-12 blogs-data">
                    @foreach ($news as $row)
                        <div class="content-box wow fadeIn">
                            ...
                            <img class="blog-main-img" src="{{ asset('uploads/event/' . $row->image) }}" alt=""
                                srcset="">
                            <h4>{{ $row->title_en }}</h4>
