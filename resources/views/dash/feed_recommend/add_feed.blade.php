...
@section('page_title' , 'Add New Feed Links')
...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    ...
    <div class="container-xxl">
        ...
        <form id="kt_ecommerce_add_product_form"
            ...
            action="{{ route('dashboard.feedRecommend.store') }}">
            @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="link_title_en" class="form-control mb-2"
                                            placeholder="link_title_en" value="{{ old('link_title_en') }}">
                                        <!--end::Input-->
                                        @error('link_title_en')
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="link_title_ar" class="form-control mb-2"
                                            placeholder="link_title_ar" value="{{ old('link_title_ar') }}">
                                        <!--end::Input-->
                                        @error('link_title_ar')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
