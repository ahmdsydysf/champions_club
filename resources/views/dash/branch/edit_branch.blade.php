                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <input class="form-check-input m-3" {{ $branch->master_branch == 1 ?
                                            'checked' : '' }} name="master_branch"
                                            type="radio" value="1" id="flexRadioDefault" />
                                            <label class="form-check-label m-3" for="flexRadioDefault">
                                                1
                                            </label>
                                            <input class="form-check-input m-3" {{ $branch->master_branch == 0 ?
                                            'checked' : '' }} name="master_branch" type="radio"
