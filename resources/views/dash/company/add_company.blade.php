...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    ...
    <div class="container-xxl">
        ...
        <form id="kt_ecommerce_add_product_form"
            ...
            action="{{ route('dashboard.company.store') }}">
            @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="about_master_en" class="form-control mb-2"
                                            placeholder="about master en" value="{{ old('about_master_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="about_master_ar" class="form-control mb-2"
                                            placeholder="about master ar" value="{{ old('about_master_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="about_details_en" class="form-control mb-2"
                                            placeholder="about details en" value="{{ old('about_details_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="about_details_ar" class="form-control mb-2"
                                            placeholder="about details ar" value="{{ old('about_details_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="about_video" class="form-control mb-2"
                                            placeholder="about video" value="{{ old('about_video') }}">
                                        <!--end::Input-->
                                        @error('about_video')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="sports_title_en" class="form-control mb-2"
                                            placeholder="sports title en" value="{{ old('sports_title_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="sports_title_ar" class="form-control mb-2"
                                            placeholder="sports title ar" value="{{ old('sports_title_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="sports_text_en" class="form-control mb-2"
                                            placeholder="sports_text_en" value="{{ old('sports_text_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="sports_text_ar" class="form-control mb-2"
                                            placeholder="sports text ar" value="{{ old('sports_text_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="services_text_en" class="form-control mb-2"
                                            placeholder="services text en" value="{{ old('services_text_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="services_text_ar" class="form-control mb-2"
                                            placeholder="services_text_ar" value="{{ old('services_text_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="services_title_en" class="form-control mb-2"
                                            placeholder="services_title_en" value="{{ old('services_title_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="services_title_ar" class="form-control mb-2"
                                            placeholder="services_title_ar" value="{{ old('services_title_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="membership_text_en" class="form-control mb-2"
                                            placeholder="membership_text_en" value="{{ old('membership_text_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="membership_text_ar" class="form-control mb-2"
                                            placeholder="membership_text_ar" value="{{ old('membership_text_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="membership_title_en" class="form-control mb-2"
                                            placeholder="membership_title_en" value="{{ old('membership_title_en') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="membership_title_ar" class="form-control mb-2"
                                            placeholder="membership_title_ar" value="{{ old('membership_title_ar') }}">
                                        <!--end::Input-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="news_text_en" class="form-control mb-2"
                                            placeholder="news_text_en" value="{{ old('news_text_en') }}">
                                        <!--end::Input-->
                                        @error('news_text_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="news_text_ar" class="form-control mb-2"
                                            placeholder="news_text_ar" value="{{ old('news_text_ar') }}">
                                        <!--end::Input-->
                                        @error('news_text_ar')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="news_title_en" class="form-control mb-2"
                                            placeholder="news_title_en" value="{{ old('news_title_en') }}">
                                        <!--end::Input-->
                                        @error('news_title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="news_title_ar" class="form-control mb-2"
                                            placeholder="news_title_ar" value="{{ old('news_title_ar') }}">
                                        <!--end::Input-->
                                        @error('news_title_ar')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
