...
@section('page_title' , 'Edit Slider Images')
...
<div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
    ...
    <div class="container-xxl">
        ...
        <form id="kt_ecommerce_add_product_form"
            ...
            action="{{ route('dashboard.slider_image.update' , ['slider_image' => $sliderImage->id]) }}">
            @csrf
            @method('PUT')
            <!--begin::Aside column-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
                            style="background-image: url('{{ asset('uploads/slider/' . $sliderImage->image) }}')">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="title_en" class="form-control mb-2"
                                            placeholder="Slider EN Title" value="{{ $sliderImage->title_en }}">
                                        <!--end::Input-->
                                        @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="title_ar" class="form-control mb-2"
                                            placeholder="Slider AR Title" value="{{ $sliderImage->title_ar }}">
                                        <!--end::Input-->
                                        @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="subtitle_en" class="form-control mb-2"
                                            placeholder="Slider EN Sub-Title" value="{{ $sliderImage->subtitle_en }}">
                                        <!--end::Input-->
                                        @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="subtitle_ar" class="form-control mb-2"
                                            placeholder="Slider AR Sub-Title" value="{{ $sliderImage->subtitle_ar }}">
                                        <!--end::Input-->
                                        @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="nav_title_en" class="form-control mb-2"
                                            placeholder="Slider EN Nav-Title" value="{{ $sliderImage->nav_title_en }}">
                                        <!--end::Input-->
                                        @error('nav_title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="nav_title_ar" class="form-control mb-2"
                                            placeholder="Slider AR Nav-Title" value="{{ $sliderImage->nav_title_ar }}">
                                        <!--end::Input-->
                                        @error('nav_title_ar')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="nav_subtitle_en" class="form-control mb-2"
                                            placeholder="Slider EN Nav-SubTitle"
                                            value="{{ $sliderImage->nav_subtitle_en }}">
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="nav_subtitle_ar" class="form-control mb-2"
                                            placeholder="Slider EN Nav-SubTitle"
                                            value="{{ $sliderImage->nav_subtitle_ar }}">
                                        <!--end::Input-->
